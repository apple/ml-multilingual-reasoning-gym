# Task: Refine Translation Based on Previous Attempts and Feedback

<task>
You are tasked with refining templates from English to {TARGET_LANGUAGE} ({TARGET_LOCALE}) that are used to procedurally generate reasoning problems such as math, logic or coding problems. These templates contain placeholders that get filled with specific values to create concrete problems. Given the context, examples, previous translation attempts, and feedback below, create an improved translation while maintaining the structure and functionality.
</task>
...
<german>
<question>
Wie viele 1-Bits gibt es in der binären Darstellung der Zahl 1373158607?
</question>
<answer>
18
</answer>
...
<german>
<question>
Wie viele 1-Bits gibt es in der binären Darstellung der Zahl 82789451?
</question>
<answer>
14
</answer>
...
<german>
<question>
Wie viele 1-Bits gibt es in der binären Darstellung der Zahl 877324117?
</question>
<answer>
16
</answer>
...
<german>
<question>
Wie viele 1-Bits gibt es in der binären Darstellung der Zahl 583848003?
</question>
<answer>
12
</answer>
...
<german>
<question>
Wie viele 1-Bits gibt es in der binären Darstellung der Zahl 1907541172?
</question>
<answer>
15
</answer>
...
<llm_feedback>
The translation of '1-Bits' sounds too literal - in German, it would be more natural to say 'Einsen' (ones). The phrase 'binären Darstellung' could be more naturally expressed as the compound noun 'Binärdarstellung'. Mathematical terminology should follow German conventions more consistently.
</llm_feedback>
...
Die Ausgabe wird generiert, indem dieselbe Regel angewendet wird, die in den bereitgestellten Beispielen die Eingabe auf die Ausgabe abbildet. Deine Antwort sollte eine Liste von Elementen sein.
Beispiele:
Eingabe 1: [54, 63, 33, 11, 39, 44, 3]
Ausgabe 1: [14]
Eingabe 2: [62, 2, 15, 37]
Ausgabe 2: [17]
Eingabe 3: [40, 96, 84, 5]
Ausgabe 3: [5]
Eingabe 4: [18, 35, 95, 20]
Ausgabe 4: [38]


Eingabe: [98, 92, 55, 10, 79, 53]
Ausgabe:
</question>
<answer>
[10]
...
Die Ausgabe wird generiert, indem dieselbe Regel angewendet wird, die in den bereitgestellten Beispielen die Eingabe auf die Ausgabe abbildet. Deine Antwort sollte eine Liste von Elementen sein.
Beispiele:
Eingabe 1: [52, 6, 76, 76]
Ausgabe 1: [53, 6, 76, 77]
Eingabe 2: [82, 67, 20, 75, 69, 5]
Ausgabe 2: [83, 67, 20, 75, 69, 6]
Eingabe 3: [9, 41, 81]
Ausgabe 3: [10, 41, 82]
Eingabe 4: [4, 18, 71]
Ausgabe 4: [5, 18, 72]
...
<instructions>
Analyze the provided information, previous translation attempts, target language examples, and LLM feedback to create an improved translation of the JSON file. Incorporate the feedback to address any identified issues while maintaining the quality requirements. Return the translated JSON content directly without any status indicators or explanations. **Important: Your response must be enclosed within `<answer></answer>` tags.** Your translation quality will be judged by how natural and fluent the **generated problems** sound in {TARGET_LANGUAGE} ({TARGET_LOCALE}), not just how literally accurate the template translation is.
...
3. **Consistency with English version**: It is crucial that the translated templates keep all information that is provided in the original English version. For example, if the English version mentions "adding real numbers", the translated templates must inlcude this information as well and not just mention "numbers" 
...
2. **Examine previous attempts and feedback** to understand what issues need to be addressed
3. **Address feedback systematically** - make specific improvements based on the LLM feedback provided
4. **Review target language examples** to ensure consistency with the expected output format and style
5. **Imagine the filled templates** - how will they sound when all slots are filled with actual values?
6. **Prioritize generated fluency** - a template that seems awkward in of itself but generates natural problems is better than a literal translation that generates stilted problems
7. **Test template combinations** - ensure templates work well together when the code combines them
</translation_strategy>