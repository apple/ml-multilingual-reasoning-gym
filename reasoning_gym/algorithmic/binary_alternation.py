...
@dataclass
class BinaryAlternationConfig(DatasetConfig):
...
class BinaryAlternationDataset(MultilingualProceduralDataset):
    ...
    def _generate_item(self, idx: int, language: str) -> dict[str, Any]:
        """Generate a single binary alternation question in the specified language"""
