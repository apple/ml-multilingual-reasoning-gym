...
@dataclass
class BinaryMatrixConfig(DatasetConfig):
...
class BinaryMatrixDataset(MultilingualProceduralDataset):
    ...
    def _generate_item(self, idx: int, language: str) -> dict[str, Any]:
        """Generate a single Binary Matrix question in the specified language.
