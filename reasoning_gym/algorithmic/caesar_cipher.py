...
@dataclass
class CaesarCipherConfig(DatasetConfig):
    ...
    language_weights: Optional[list[float]] = None  # Add language weights
...
class CaesarCipherDataset(MultilingualProceduralDataset):
    ...
    def _generate_item(self, idx: int, language: str) -> dict[str, Any]:
        ...
        # Generate question using translation
        question = self._get_translation("question_template", language, cipher_text=cipher_text)
