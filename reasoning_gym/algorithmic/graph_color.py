...
@dataclass
class GraphColorConfig(DatasetConfig):
...
class GraphColorDataset(MultilingualProceduralDataset):
    ...
    def _generate_item(self, idx: int, language: str) -> dict[str, Any]:
        """Generate a single GraphColor task for the given index and language.
        ...
        Returns:
            dict with keys:
                ...
                - metadata: dict with generation parameters including language
        """
