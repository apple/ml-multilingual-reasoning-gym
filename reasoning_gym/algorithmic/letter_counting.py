...
@dataclass
class LetterCountingConfig(DatasetConfig):
...
class LetterCountingDataset(MultilingualProceduralDataset):
    ...
    def _generate_item(self, idx: int, language: str) -> dict[str, Any]:
        """Generate a single letter counting task for a given language"""
        ...
        # Create the question using translation
