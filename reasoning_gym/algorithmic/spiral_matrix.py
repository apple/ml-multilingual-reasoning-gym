...
@dataclass
class SpiralMatrixConfig(DatasetConfig):
...
class SpiralMatrixDataset(MultilingualProceduralDataset):
    ...
    def _generate_item(self, idx: int, language: str) -> dict[str, Any]:
        """Generate a single Spiral Matrix question in the specified language.
        
        Args:
            idx: The index of the item to generate.
            language: The language code for the question.
        ...
        question = self._get_translation("question_template", language, matrix=matrix_str)
