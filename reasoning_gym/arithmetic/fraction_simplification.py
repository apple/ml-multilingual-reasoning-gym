...
@dataclass
class FractionSimplificationConfig(DatasetConfig):
    ...
    languages: list[str] | str = "en"  # Language(s) for the task
...
class FractionSimplificationDataset(MultilingualProceduralDataset):
    ...
    def _generate_item(self, idx: int, language: str) -> dict[str, Any]:
        """Generate a single fraction simplification task for a specific language"""
        ...
        question = self._get_translation("question_template", language, question_fraction=question_fraction)
