...
@dataclass
class PrimeFactorizationConfig(DatasetConfig):
    ...
    language_weights: Optional[list[float]] = None  # Language sampling weights
...
class PrimeFactorizationDataset(MultilingualProceduralDataset):
    ...
    def _generate_item(self, idx: int, language: str) -> dict[str, Any]:
        """Generate a single prime factorization task in the specified language"""
        ...
        # Use translation for question format
