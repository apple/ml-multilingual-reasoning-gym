...
@dataclass
class FutoshikiConfig(DatasetConfig):
...
class FutoshikiDataset(MultilingualProceduralDataset):
    ...
    def _generate_item(self, idx: int, language: str) -> dict[str, Any]:
        ...
        Args:
            ...
            language: The language for the question text
        ...
        question = self._get_translation("prompt_template", language, board_size=board_size, puzzle_str=puzzle_str)
