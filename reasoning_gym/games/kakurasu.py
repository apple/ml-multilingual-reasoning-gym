...
@dataclass
class KakurasuConfig(DatasetConfig):
    min_rows: int = 4
    max_rows: int = 5
    min_cols: int = 4
    max_cols: int = 5
...
class KakurasuDataset(MultilingualProceduralDataset):
    ...
    def _generate_item(self, idx: int, language: str) -> dict[str, Any]:
        """Generate a single multilingual Kakurasu puzzle instance.
        
        Args:
            idx: The index of the item to generate
            language: The language code for the puzzle text
        ...
        for retry in range(self.config.max_retries):
            ...
            template_num = rng.randint(1, 10)  # We have 10 templates
