...
@dataclass
class MiniSudokuConfig(DatasetConfig):
...
class MiniSudokuDataset(MultilingualProceduralDataset):
    ...
    def _generate_item(self, idx: int, language: str) -> dict[str, Any]:
        """Generate a single mini sudoku puzzle for a specific language"""
        ...
        question = self._get_translation("prompt_template", language, puzzle=puzzle_str)
