...
def test_letter_jumble_curriculum():
    ...
    assert base_cfg.min_word_len == 2 and base_cfg.max_word_len == 3
    ...
    assert increased_cfg.min_word_len == 2 and increased_cfg.max_word_len == 4
    ...
    assert partially_decreased_cfg.min_word_len == 2 and partially_decreased_cfg.max_word_len == 4
